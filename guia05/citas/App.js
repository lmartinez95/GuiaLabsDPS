      ...
      <View style={styles.contenedor}>
        ...
        <View>
          <TouchableHighlight onPress={ () => mostrarFormulario() } style={styles.btnMostrarForm}>
            <Text style={styles.textoMostrarForm}>{mostrarForm ? "Cancelar Crar Cita" : "Crear Nueva Cita"}</Text>
          </TouchableHighlight>
        </View>
        <View style={styles.contenido}>
          {mostrarForm ? (
            ...
            <FlatList
              ...
              data={citas}
              renderItem={ ({item}) => <Cita item={item} eliminarPaciente={eliminaPacienre} /> }
